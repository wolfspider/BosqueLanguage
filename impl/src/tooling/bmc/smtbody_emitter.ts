    ...
    generateBuiltinBody(issafe: boolean, idecl: MIRInvokePrimitiveDecl, params: string[]): SMTExp {
        ...
        switch (idecl.implkey) {
            ...
            case "string_readline": {
                bodyres = this.typegen.generateSpecialTypeFieldAccessExp(enclkey, "stdin", params[0]);
                break;
            }
            case "string_writeline": {
                bodyres = this.typegen.generateSpecialTypeFieldAccessExp(enclkey, "stdout", params[0]);
                break;
            }
            case "string_concat": {
